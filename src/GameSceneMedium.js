...
class GameSceneMedium extends Scene {
  constructor() {
    super("gameMedium");
  }

  preload() {
    this.load.image("img_skyMedium", "src/assets/skyMedium.png");
  ...
  create() {
    //guidance https://phaser.discourse.group/t/how-to-stretch-background-image-on-full-screen/1839
    ...
    groupPlateforms.create(100, 200, "img_platform");
    groupPlateforms.create(200, 800, "img_platform");
    groupPlateforms.create(500, 100, "img_platform");
    groupPlateforms.create(700, 500, "img_platform");
    groupPlateforms.create(50, 540, "img_platform");
    groupPlateforms.create(750, 270, "img_platform");

    //guidance https://phaser.io/examples/v3/view/physics/arcade/basic-platform
    movingPlatformFirst = this.physics.add.staticGroup();
    movingPlatformFirst = this.physics.add.image(100, 350, "img_platform");
    movingPlatformFirst.setImmovable(true);
    movingPlatformFirst.body.allowGravity = false;
    movingPlatformFirst.setVelocityX(50);
  ...
  update() {
    ...
    if (movingPlatformFirst.x >= 700) {
      movingPlatformFirst.setVelocityX(-50);
    } else if (movingPlatformFirst.x <= 100) {
      movingPlatformFirst.setVelocityX(50);
    }

    if (movingPlatformSecond.x >= 700) {
      movingPlatformSecond.setVelocityX(-50);
...
export default GameSceneMedium;
